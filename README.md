...
- Libraries and tools: TensorFlow, OpenCV, NumPy, Pandas, JavaFX, Git
...
- Clean project architecture, documentation, and maintainable code
...
More public projects are on the way as I finish polishing them for release.
